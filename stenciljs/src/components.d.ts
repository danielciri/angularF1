...
export namespace Components {
    ...
    interface CardDriverComponentRaces {
        "position": number;
        "raceName": String;
        "time": string;
    }
...
declare global {
    ...
    interface HTMLCardDriverComponentRacesElement extends Components.CardDriverComponentRaces, HTMLStencilElement {
    }
    var HTMLCardDriverComponentRacesElement: {
        prototype: HTMLCardDriverComponentRacesElement;
        new (): HTMLCardDriverComponentRacesElement;
    };
    ...
    interface HTMLElementTagNameMap {
        ...
        "card-driver-component-races": HTMLCardDriverComponentRacesElement;
...
declare namespace LocalJSX {
    ...
    interface IntrinsicElements {
        ...
        "card-driver-component-races": CardDriverComponentRaces;
...
declare module "@stencil/core" {
    export namespace JSX {
        interface IntrinsicElements {
            ...
            "card-driver-component-races": LocalJSX.CardDriverComponentRaces & JSXBase.HTMLAttributes<HTMLCardDriverComponentRacesElement>;
